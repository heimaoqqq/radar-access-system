      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        >
          <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-6 flex items-center gap-2">
            <div className="p-1.5 bg-gradient-to-r from-purple-100 to-violet-100 rounded-lg">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100">
              ...
              <div className="w-full bg-green-100 rounded-full h-3 shadow-inner">
                <div className="bg-gradient-to-r from-green-400 to-green-500 h-3 rounded-full shadow-sm transition-all duration-500" style={{ width: '32%' }}></div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-100">
              ...
              <div className="w-full bg-blue-100 rounded-full h-3 shadow-inner">
                <div className="bg-gradient-to-r from-blue-400 to-blue-500 h-3 rounded-full shadow-sm transition-all duration-500" style={{ width: '45%' }}></div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-4 rounded-xl border border-amber-100">
              ...
              <div className="w-full bg-amber-100 rounded-full h-3 shadow-inner">
                <div className="bg-gradient-to-r from-amber-400 to-yellow-500 h-3 rounded-full shadow-sm transition-all duration-500" style={{ width: '67%' }}></div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-4 rounded-xl border border-purple-100">
              ...
              <div className="w-full bg-purple-100 rounded-full h-3 shadow-inner">
                <div className="bg-gradient-to-r from-purple-400 to-violet-500 h-3 rounded-full shadow-sm transition-all duration-500" style={{ width: '12%' }}></div>
              </div>
            </div>
          </div>
        </motion.div>
