          ...
          >
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8 flex-1 flex flex-col">
              ...
              {mode === 'register' ? (
                ...
                <div className="space-y-4">
                  <div className={`${identificationResult ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'} border rounded-lg p-4`}>
                    <div className="flex items-center mb-2">
                      {identificationResult ? (
                        ...
                        <>
                          ...
                          <span className="font-semibold text-gray-600">用户信息</span>
                        </>
                      )}
                    </div>
